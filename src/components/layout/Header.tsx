      ...
      <div className="bg-secondary-900 text-white py-2 hidden lg:block">
        <div className="container-custom flex items-center justify-between text-sm">
          <div className="flex items-center gap-6">
            <a href="tel:910023016" className="flex items-center gap-2 hover:text-primary-400 transition-colors">
            ...
            >
              ...
              <span>C/ Polo Sur 2, Torrejón de Ardoz</span>
            </a>
            <div className="flex items-center gap-2 text-secondary-400">
              <Clock className="w-4 h-4" />
              <span>L-J: 9-14h / 16-20:30h | V: 9-17h | D: 11-14h</span>
            </div>
          </div>
        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-4">
              <a href="tel:910023016" className="btn-primary">
                <Phone className="w-4 h-4" />
                Llámanos
              </a>
            </div>
          ...
          <div className="lg:hidden border-t border-secondary-100 bg-white animate-slide-down">
            <div className="container-custom py-4 space-y-2">
              ...
              <div className="pt-4 border-t border-secondary-100">
                <a href="tel:910023016" className="btn-primary w-full justify-center">
                  <Phone className="w-4 h-4" />
                  Llámanos
                </a>
              </div>
