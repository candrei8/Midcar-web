...
export async function generateMetadata({ searchParams }: BlogPageProps): Promise<Metadata> {
  ...
  const title = q
    ? `Resultados de "${q}" - Blog MID Car`
    : 'El Blog MIDCar - Noticias, guías y consejos de coches ocasión'
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="text-center">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                {q ? `Resultados de "${q}"` : 'Noticias y consejos'}
              </h1>
                ...
                {posts.length > 0 ? (
                  ...
                  <div className="bg-gray-50 rounded-lg p-12 text-center">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      {q ? 'No se encontraron artículos' : 'No hay artículos'}
                    </h3>
                    ...
                    {q && (
                      <Link href="/blog" className="inline-block text-[#135bec] hover:underline font-medium">
